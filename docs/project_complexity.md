...
**Last Measured:** 2026-09-12T13:01:29.183274+00:00 · **Release:** `3.3.21` · **Dev Version:** `3.3.22-dev2`
...
| **Mean Complexity per Routine** | **3.02** | Across 385 routines (Ideal $< 4.0$ per routine) |
...
| **Source Python SLOC** | **10,704** | Across 20 files in custom_components/ (code statements) |
| **Docstring Volume** | **2,671 lines** | Interface and contract documentation |
| **Comment Density** | **25.4%** | 2,716 inline comment lines (Advisory: > 25% inspect for procedural narration) |
| **Platform Declarations SLOC** | **3,003 lines** | Across 6 platform files |
| **Core Engine / Driver SLOC** | **7,701 lines** | Across 14 coordinator/API/helper files |
...
| **Test-to-Source Ratio** | **1.38×** | 14,779 test lines ($\ge 1.5×$ recommended) |
| **Pytest Coverage** | **100%** | 1650 tests executed |
| **Pytest Duration** | **393.88s** | Full test suite wall-clock execution time |

## 2. High Complexity Routines ($\ge 10$)

| Score  | Routine Symbol              | Location                   | Status     |
| :----: | :-------------------------- | :------------------------- | :--------- |
| **19** | `_request`                  | `api.py:1565`              | `ELEVATED` |
...
| **11** | `login`                     | `api.py:1775`              | `ELEVATED` |
| **11** | `probe_names`               | `api.py:2418`              | `ELEVATED` |
...
| `api.py:1459` | 21 lines | Long procedural block; consider moving architecture notes to docs |
...
| `api.py:2557` | 16 lines | Long procedural block; consider moving architecture notes to docs |
...
| `api.py:3020` | 15 lines | Long procedural block; consider moving architecture notes to docs |
...
| `api.py:2700` | 14 lines | Long procedural block; consider moving architecture notes to docs |
| `api.py:2962` | 14 lines | Long procedural block; consider moving architecture notes to docs |
...
| `api.py:1895` | 13 lines | Long procedural block; consider moving architecture notes to docs |
| `api.py:2685` | 13 lines | Long procedural block; consider moving architecture notes to docs |
...
| `api.py:2490` | 12 lines | Long procedural block; consider moving architecture notes to docs |
...
| `api.py:2180` | 11 lines | Long procedural block; consider moving architecture notes to docs |
...
| `api.py:2818` | 10 lines | Long procedural block; consider moving architecture notes to docs |
...
| `api.py:1724` | 9 lines | Long procedural block; consider moving architecture notes to docs |
| `api.py:2932` | 9 lines | Long procedural block; consider moving architecture notes to docs |
| `api.py:3351` | 9 lines | Long procedural block; consider moving architecture notes to docs |
...
| `get_ad` | `api.py:3330` | 22 comm / 18 code | Comments exceed code statements; verify against procedural narration |
| `get_params` | `api.py:2991` | 15 comm / 13 code | Comments exceed code statements; verify against procedural narration |
