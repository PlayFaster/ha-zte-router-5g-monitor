...
**Last Measured:** 2026-09-23T20:54:33.462909+00:00 · **Release:** `3.4.2` · **Dev Version:** `3.4.2-dev3`
...
| **Mean Complexity per Routine** | **2.93** | Across 407 routines (Ideal $< 4.0$ per routine) |
...
| **Source Python SLOC** | **10,485** | Across 21 files in custom_components/ (code statements) |
| **Docstring Volume** | **3,242 lines** | Interface and contract documentation |
| **Comment Density** | **26.9%** | 2,822 inline comment lines (Advisory: > 25% inspect for procedural narration) |
| **Platform Declarations SLOC** | **3,094 lines** | Across 6 platform files |
| **Core Engine / Driver SLOC** | **7,391 lines** | Across 15 coordinator/API/helper files |
...
| **Test-to-Source Ratio** | **1.63×** | 17,134 test lines ($\ge 1.5×$ recommended) |
| **Pytest Coverage** | **99%** | 1881 tests executed |
| **Pytest Duration** | **179.15s** | Full test suite wall-clock execution time |
...
| 4915 | `S324` | `api.py` |
| 5053 | `BLE001` | `api.py` |
| 698 | `BLE001` | `coordinator.py` |
| 1170 | `BLE001` | `coordinator.py` |
| 1207 | `BLE001` | `coordinator.py` |
| 1224 | `BLE001` | `coordinator.py` |
| 1245 | `BLE001` | `coordinator.py` |
| 93 | `S324` | `device_profile.py` |
| 571 | `BLE001` | `diagnostics.py` |
| 586 | `BLE001` | `diagnostics.py` |
| 163 | `BLE001, S112` | `observations.py` |
| 214 | `BLE001` | `observations.py` |
| 474 | `BLE001` | `observations.py` |
| 400 | `BLE001` | `switch.py` |
| 482 | `BLE001` | `switch.py` |
...
| `coordinator.py:1039` | 21 lines | Long procedural block; consider moving architecture notes to docs |
...
| `const.py:341` | 18 lines | Long procedural block; consider moving architecture notes to docs |
...
| `coordinator.py:191` | 17 lines | Long procedural block; consider moving architecture notes to docs |
...
| `const.py:417` | 15 lines | Long procedural block; consider moving architecture notes to docs |
...
| `coordinator.py:86` | 12 lines | Long procedural block; consider moving architecture notes to docs |
...
| `const.py:486` | 11 lines | Long procedural block; consider moving architecture notes to docs |
| `coordinator.py:62` | 11 lines | Long procedural block; consider moving architecture notes to docs |
| `coordinator.py:174` | 11 lines | Long procedural block; consider moving architecture notes to docs |
...
| `coordinator.py:115` | 10 lines | Long procedural block; consider moving architecture notes to docs |
