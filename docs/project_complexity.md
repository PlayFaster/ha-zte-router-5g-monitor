...
**Last Measured:** 2026-09-15T14:55:10.106038+00:00 · **Release:** `3.3.25` · **Dev Version:** `3.3.25`
...
| **Mean Routine Length** | **15.8 code lines** | Target $\le 15$ code lines ideal |
...
| **Largest Module** | **2,490 code lines** | `api.py` (Warn $> 1,500$ code lines module bloat) |
...
| **Source Python SLOC** | **10,021** | Across 21 files in custom_components/ (code statements) |
| **Docstring Volume** | **3,062 lines** | Interface and contract documentation |
| **Comment Density** | **26.9%** | 2,700 inline comment lines (Advisory: > 25% inspect for procedural narration) |
| **Platform Declarations SLOC** | **3,003 lines** | Across 6 platform files |
| **Core Engine / Driver SLOC** | **7,018 lines** | Across 15 coordinator/API/helper files |
...
| **Test-to-Source Ratio** | **1.6×** | 16,053 test lines ($\ge 1.5×$ recommended) |
| **Pytest Coverage** | **100%** | 1768 tests executed |
| **Pytest Duration** | **299.74s** | Full test suite wall-clock execution time |
...
| **12** | `login` | `api.py:2643` | `ELEVATED` |
| **11** | `probe_names` | `api.py:3268` | `ELEVATED` |
...
| :-- | :-: | :-- |
| `api.py:2190` | 21 lines | Long procedural block; consider moving architecture notes to docs |
...
| `api.py:2550` | 19 lines | Long procedural block; consider moving architecture notes to docs |
...
| `api.py:3407` | 16 lines | Long procedural block; consider moving architecture notes to docs |
...
| `api.py:3905` | 15 lines | Long procedural block; consider moving architecture notes to docs |
...
| `api.py:1657` | 14 lines | Long procedural block; consider moving architecture notes to docs |
| `api.py:3554` | 14 lines | Long procedural block; consider moving architecture notes to docs |
| `api.py:3822` | 14 lines | Long procedural block; consider moving architecture notes to docs |
| `api.py:4102` | 14 lines | Long procedural block; consider moving architecture notes to docs |
| `api.py:4624` | 14 lines | Long procedural block; consider moving architecture notes to docs |
...
| `api.py:1133` | 13 lines | Long procedural block; consider moving architecture notes to docs |
| `api.py:2777` | 13 lines | Long procedural block; consider moving architecture notes to docs |
| `api.py:3539` | 13 lines | Long procedural block; consider moving architecture notes to docs |
...
| `api.py:1971` | 12 lines | Long procedural block; consider moving architecture notes to docs |
| `api.py:3340` | 12 lines | Long procedural block; consider moving architecture notes to docs |
...
| `api.py:3062` | 11 lines | Long procedural block; consider moving architecture notes to docs |
...
| `api.py:2530` | 10 lines | Long procedural block; consider moving architecture notes to docs |
| `api.py:3674` | 10 lines | Long procedural block; consider moving architecture notes to docs |
...
| `api.py:1042` | 9 lines | Long procedural block; consider moving architecture notes to docs |
| `api.py:1386` | 9 lines | Long procedural block; consider moving architecture notes to docs |
| `api.py:3788` | 9 lines | Long procedural block; consider moving architecture notes to docs |
| `api.py:5076` | 9 lines | Long procedural block; consider moving architecture notes to docs |
...
| :-- | :-- | :-: | :-- |
| `__init__` | `api.py:938` | 118 comm / 58 code | Comments exceed code statements; verify against procedural narration |
| `session_witnesses` | `api.py:1634` | 24 comm / 21 code | Comments exceed code statements; verify against procedural narration |
| `get_params` | `api.py:3876` | 15 comm / 13 code | Comments exceed code statements; verify against procedural narration |
