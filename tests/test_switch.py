...
from custom_components.zte_router_5g.switch import ZTEPausePollingSwitch, PAUSE_POLLING_DESCRIPTION
from custom_components.zte_router_5g.const import DOMAIN, CONF_STOP_POLLING
