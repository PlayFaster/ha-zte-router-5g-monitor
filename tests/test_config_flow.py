...
from custom_components.zte_router_5g.const import DOMAIN, DEFAULT_NAME
...
async def test_config_flow_user_step_success():
    ...
    with patch("custom_components.zte_router_5g.config_flow._validate_credentials", return_value=None):
