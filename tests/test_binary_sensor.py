import pytest
from custom_components.zte_router_5g.binary_sensor import ZTEBestConnectionSensor, BEST_CONN_DESCRIPTION

def test_binary_sensor_is_on(mock_coordinator, mock_config_entry):
    """Test the binary sensor is_on logic."""
    sensor = ZTEBestConnectionSensor(mock_coordinator, mock_config_entry, BEST_CONN_DESCRIPTION)
